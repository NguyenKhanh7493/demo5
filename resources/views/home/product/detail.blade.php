                        ...
                        <div class="pb-left-column col-xs-12 col-sm-5">
                            ...
                            <div class="product-image">
                                <div class="product-full">
                                    <img id="product-zoom" src='{!! url() !!}/public/home/assets/data/product-s3-420x512.jpg' data-zoom-image="{!! url() !!}/public/home/assets/data/product-s3-850x1036.jpg"/>
                                </div>
                                <div class="product-img-thumb" id="gallery_01">
                                    <ul class="owl-carousel" data-items="3" data-nav="true" data-dots="false" data-margin="21" data-loop="false">
                                        <li>
                                            <a href="#" data-image="{!! url() !!}/public/home/assets/data/product-s3-420x512.jpg" data-zoom-image="{!! url() !!}/public/home/assets/data/product-s3-850x1036.jpg">
                                                <img id="product-zoom"  src="{!! url() !!}/public/home/assets/data/product-s3-100x122.jpg" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" data-image="{!! url() !!}/public/home/assets/data/product-s2-420x512.jpg" data-zoom-image="{!! url() !!}/public/home/assets/data/product-s2-850x1036.jpg">
                                                <img id="product-zoom"  src="{!! url() !!}/public/home/assets/data/product-s2-100x122.jpg" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" data-image="{!! url() !!}/public/home/assets/data/product-420x512.jpg" data-zoom-image="{!! url() !!}/public/home/assets/data/product-850x1036.jpg">
                                                <img id="product-zoom"  src="{!! url() !!}/public/home/assets/data/product-100x122.jpg" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" data-image="{!! url() !!}/public/home/assets/data/product-s4-420x512.jpg" data-zoom-image="{!! url() !!}/public/home/assets/data/product-s4-850x1036.jpg">
                                                <img id="product-zoom"  src="{!! url() !!}/public/home/assets/data/product-s4-100x122.jpg" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" data-image="{!! url() !!}/public/home/assets/data/product-s5-420x512.jpg" data-zoom-image="{!! url() !!}/public/home/assets/data/product-s5-850x1036.jpg">
                                                <img id="product-zoom"  src="{!! url() !!}/public/home/assets/data/product-s5-100x122.jpg" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" data-image="{!! url() !!}/public/home/assets/data/product-s6-420x512.jpg" data-zoom-image="{!! url() !!}/public/home/assets/data/product-s6-850x1036.jpg">
                                                <img id="product-zoom"  src="{!! url() !!}/public/home/assets/data/product-s6-100x122.jpg" />
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <ul class="product-list owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                            ...
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="{!! url() !!}/assets/data/p36.jpg" />
                                        </a>
                                        <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
