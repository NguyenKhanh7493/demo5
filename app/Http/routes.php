...
Route::get('/tim-kiem/{cate}-{key}.html', 'Home\ProductController@getSearch')->where(['cate'=>'[0-9]+']);
Route::get('/san-pham/{text}-{cate}.html', 'Home\ProductController@getList')->where(['text'=>'[a-zA-Z-_.]+','cate'=>'[0-9]+']);
Route::get('/chi-tiet/{text}-{cate}.html', 'Home\ProductController@getDetail')->where(['text'=>'[a-zA-Z-_.]+','cate'=>'[0-9]+']);
//Route::get('home', 'HomeController@index');
/*post*/
Route::group(['prefix' => 'post'], function () {
    Route::get('bai-viet/{id}',['as'=>'admin.post.getPost','uses'=>'Home\PostController@getPost']);
    Route::get('chi-tiet/{id}/{tenloai}',['as'=>'admin.post.getDetailPost','uses'=>'Home\PostController@getDetailPost']);
});
/*admin*/
