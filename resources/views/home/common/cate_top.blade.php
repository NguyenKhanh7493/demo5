        ...
        <div class="row">
            <div class="col-sm-3" id="box-vertical-megamenus">
                <div class="box-vertical-megamenus">
                    ...
                    <div class="vertical-menu-content is-home" @yield('style_cate')>
                        <ul class="vertical-menu-list">
                            @for($i=0;$i<15;$i++)
                            <li @if($i >10) class="cat-link-orther" @endif>
                                <a class="parent" href="{!! url() !!}/san-pham/ten-danh-muc-12.html"><img class="icon-menu" alt="Funky roots" src="{!! url('public/home') !!}/assets/data/2.png">Sports {!! $i !!}</a>
                                <div class="vertical-dropdown-menu">
                                    <div class="vertical-groups col-sm-12">
                                        ...
                                        <div class="mega-custom-html col-sm-12">
                                            <a href="#"><img src="{!! url('public/home') !!}/assets/data/banner-megamenu.jpg" alt="Banner"></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                    ...
                                    <ul class="dropdown-menu mega_dropdown" role="menu" style="width: 830px;">
                                        <li class="block-container col-sm-3">
                                            <ul class="block">
                                                <li class="img_container">
                                                    <a href="#">
                                                        <img class="img-responsive" src="{!! url('public/home') !!}/assets/data/men.png" alt="sport">
                                                    </a>
                                                </li>
                                        ...
                                        <li class="block-container col-sm-3">
                                            <ul class="block">
                                                <li class="img_container">
                                                    <a href="#">
                                                        <img class="img-responsive" src="{!! url('public/home') !!}/assets/data/women.png" alt="sport">
                                                    </a>
                                                </li>
                                                <li class="link_container group_header">
                                                    <a href="#">WOMEN'S</a>
                                        ...
                                        <li class="block-container col-sm-3">
                                            <ul class="block">
                                                <li class="img_container">
                                                    <a href="#">
                                                        <img class="img-responsive" src="{!! url('public/home') !!}/assets/data/kid.png" alt="sport">
                                                    </a>
                                                </li>
                                                <li class="link_container group_header">
                                                    <a href="#">Kids</a>
                                        ...
                                        <li class="block-container col-sm-3">
                                            <ul class="block">
                                                <li class="img_container">
                                                    <a href="#">
                                                        <img class="img-responsive" src="{!! url('public/home') !!}/assets/data/trending.png" alt="sport">
                                                    </a>
                                                </li>
                                                <li class="link_container group_header">
                                                    <a href="#">TRENDING</a>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="mega_dropdown dropdown-menu" style="width: 830px;">
                                        ...
                                        <li class="block-container col-sm-3">
                                            <ul class="block">
                                                <li class="img_container">
                                                    <img src="{!! url('public/home') !!}/assets/data/banner-topmenu.jpg" alt="Banner">
                                                </li>
                                            </ul>
                                        </li>
